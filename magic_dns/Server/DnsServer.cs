...
namespace DNS.Server
{
    public class DnsServer
    {
        ...
        private DnsClient globalClient;
        private DnsClient ispClient;
        ...
        {
            this.emitter = new EventEmitter();
            this.globalClient = new DnsClient(endServer, new UdpRequestResolver());
            this.masterFile = new MasterFile();
        }
        ...
        {
            ClientRequest remoteRequest = globalClient.Create(request);
            return remoteRequest.Resolve();
        }

        protected virtual IResponse ResolveFromGlobal(Request request)
        {
            ClientRequest remoteRequest = globalClient.Create(request);
            return remoteRequest.Resolve();
        }
        protected virtual IResponse ResolveFromIsp(Request request)
        {
            ClientRequest remoteRequest = ispClient.Create(request);
            return remoteRequest.Resolve();
        }
